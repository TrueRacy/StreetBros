...
Player1 = Borec("", 100, player1_pozicija, 5, 50, "Stand", False, False, False, -30, 370, 1, False, False,0, False)
Player2 = Borec("", 100, player2_pozicija, 5, 50, "Stand", False, False, False, 850, 370, 0, False, False,0, False)
...
Player2_hoja = [pygame.transform.scale(Player2_walk_levo_2, (350, 350)),pygame.transform.scale(Player2_walk_levo_3, (350,350)), pygame.transform.scale(Player2_walk_levo_1,(350,350))]
   ...
   while Borba:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.QUIT:
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_i:  # Skok za Player1
                    Player2.skoci()
    ...
    if Player1.special == True and (fireball.x == Player2.x):
        Player1.special = False
    elif Player1.special == True and (fireball.x != Player2.x):
        Player1.special = True
        if Player1.smer == 1:
            fireball.premik_desno()
            screen.blit(fireball_slika, (fireball.x+150, fireball.y+100))

        else:
            fireball.premik_levo()
            screen.blit(fireball_slika, (fireball.x+150, fireball.y+100))
...
# V glavni while zanki:
    ...
    if Player1.skok:
        Player1.y += Player1.hitrost_skoka  # Premik navzgor/navzdol
        Player1.hitrost_skoka += 1  # Upočasnjevanje skoka (gravitacija)

        # Ko igralec doseže tla, ustavi skok
